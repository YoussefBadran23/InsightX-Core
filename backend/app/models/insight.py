"""Insight model — Gemini 2.0 Flash generated bullet insights per analysis run."""
...
class Insight(UUIDMixin, TimestampMixin, Base):
    ...
    Gemini 2.0 Flash model (worker/services/llm_insights.py) after each analysis run.
    ...
    # The Gemini 2.0 Flash generated insight text
