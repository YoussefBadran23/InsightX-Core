...
import {
  ...
  Bell, LogOut, User, Sun, Moon, Globe, ChevronDown, Check,
} from 'lucide-react';
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-background-light dark:bg-background-dark text-slate-900 dark:text-white font-sans">
      {/* Side Navigation */}
      <aside className="flex w-64 flex-col justify-between border-e border-gray-200 dark:border-surface-border bg-white dark:bg-background-dark p-4">
