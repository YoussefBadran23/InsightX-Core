...
export function PublicHeader() {
  ...
  // Logo always returns to the marketing landing. This matches every web
  // convention (logo = home) and avoids the stale-auth loop where a leftover
  // cookie sent users to /dashboard → /login.
  const logoHref = '/';
