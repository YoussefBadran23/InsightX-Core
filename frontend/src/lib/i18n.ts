...
const translations = {
  en: {
    ...
    fp_subtitle: "Enter your email and we'll send you a link to reset your password.",
    fp_sendLink: 'Send Reset Link',
    fp_sending: 'Sending Link...',
    fp_backToLogin: 'Back to Login',
    fp_returnToLogin: 'Return to Login',
    fp_successMsg: 'If an account exists for that email, a password reset link has been sent.',
    fp_errorFallback: 'An unexpected error occurred. Please try again.',

    // ── Support / Terms / Privacy ──
    helpCenterTitle: 'Help Center & Support',
    contactUs: 'Contact Us',
    contactUsText: 'Need assistance with your data pipeline or analytics dashboard? Our team is here to help. Please reach out to us at {email} and we will respond within 24 hours.',
    faq: 'FAQ',
    ...
    cust_summaryAvgLtv: 'Average LTV',
    cust_summaryAvgLtvSub: 'across all customers',
    cust_summaryVip: 'VIP Champions',
    cust_summaryVipSub: 'High-value champions',
    ...
    prod_tierUnranked: 'Unranked',
    prod_export: 'Export',
    prod_exporting: 'Exporting…',
    ...
    fc_today: 'Today',
    fc_statLast30: 'Last 30 days',
    fc_statNext30: 'Next 30 days (forecast)',
    fc_statChange: 'Change vs. recent',
    fc_statChangeSub: 'forecast vs. last 30d avg',
    fc_statTotal: 'Forecast revenue',
    fc_statTotalSub: 'day projected total',
    fc_statPerDay: 'avg / day',
    ...
    seg_scatterTitle: 'Segment universe',
    seg_sidebarTitle: 'Customer Segments',
    seg_sidebarSubtitle: 'customers analyzed',
    seg_avgLtv: 'Avg LTV',
    seg_revShare: 'Revenue share',
    seg_createCampaign: 'Export Segment',
    seg_createCampaignAll: 'Export All Customers',
    seg_exportAll: 'Export All',
    seg_noData: 'No RFM data yet. Upload a CSV with customer_id, order_date, and total_amount.',
    seg_clearFilter: 'Clear filter',
    seg_customers: 'customers',
    seg_dataPoints: 'customers in dataset',
    seg_inSegment: 'in segment',
    seg_familyChampion: 'Champions',
    seg_familyLoyal: 'Loyal',
    seg_familyNew: 'New / Promising',
    seg_familyRisk: 'At-Risk',
    seg_campaignHint: 'Exports {n} customers in “{seg}” as a CSV target list.',
    seg_dragHint: 'drag to move, click to filter',
    seg_resetPositions: 'Reset positions',
    ...
    onb_sourceCurrencyLabel: 'CSV currency',
    onb_sourceCurrencyHint: 'Which currency are the amounts in your file? We use this to convert values into your preferred display currency.',
    onb_sourceCurrencyAuto: 'Auto-detect from file',
    ...
    settings_themeHint: 'Switch between light and dark themes',
    settings_languageLabel: 'Language',
    settings_languageHint: 'Choose your preferred display language',
    settings_signOut: 'Sign Out',
    settings_company: 'Company',
    settings_companyDesc: 'Customise how your brand appears across InsightX',
    settings_companyName: 'Company name',
    settings_companyNamePlaceholder: 'Your company name',
    settings_manageAccountPrefs: 'Manage your account preferences',
    settings_preferences: 'Preferences',
    settings_currency: 'Currency',
    settings_currencyHint: 'Used for revenue formatting across dashboards',
    settings_noLogo: 'No logo uploaded yet',
    settings_uploadLogo: 'Upload logo',
    settings_changeLogo: 'Change logo',
    settings_logoMustBeImage: 'Logo must be an image file (PNG, JPG, SVG).',
    settings_logoTooLarge: 'Logo file is too large.',
  ...
  ar: {
    ...
    fp_subtitle: 'أدخل بريدك الإلكتروني وسنرسل لك رابطاً لإعادة تعيين كلمة المرور.',
    fp_sendLink: 'إرسال رابط الإعادة',
    fp_sending: 'جاري الإرسال...',
    fp_backToLogin: 'العودة إلى تسجيل الدخول',
    fp_returnToLogin: 'العودة إلى تسجيل الدخول',
    fp_successMsg: 'إذا كان هناك حساب مرتبط بهذا البريد الإلكتروني، فقد تم إرسال رابط إعادة التعيين.',
    fp_errorFallback: 'حدث خطأ غير متوقع. يرجى المحاولة مرة أخرى.',

    // ── Support / Terms / Privacy ──
    helpCenterTitle: 'مركز المساعدة والدعم',
    contactUs: 'اتصل بنا',
    contactUsText: 'هل تحتاج إلى مساعدة بشأن بياناتك أو لوحة التحليلات؟ فريقنا هنا للمساعدة. يرجى التواصل معنا على {email} وسنرد عليك خلال 24 ساعة.',
    faq: 'الأسئلة الشائعة',
    ...
    cust_summaryAvgLtv: 'متوسط القيمة',
    cust_summaryAvgLtvSub: 'لجميع العملاء',
    cust_summaryVip: 'كبار العملاء',
    cust_summaryVipSub: 'عملاء عاليي القيمة',
    ...
    prod_tierUnranked: 'غير مصنف',
    prod_export: 'تصدير',
    prod_exporting: 'جاري التصدير…',
    ...
    fc_today: 'اليوم',
    fc_statLast30: 'آخر 30 يومًا',
    fc_statNext30: '30 يومًا قادمة (متوقع)',
    fc_statChange: 'التغير مقارنة',
    fc_statChangeSub: 'التوقع مقابل آخر 30 يومًا',
    fc_statTotal: 'إيرادات متوقعة',
    fc_statTotalSub: 'يومًا إجمالي التوقع',
    fc_statPerDay: 'متوسط يومي',
    ...
    seg_scatterTitle: 'كون الفئات',
    seg_sidebarTitle: 'فئات العملاء',
    seg_sidebarSubtitle: 'عميل تم تحليله',
    seg_avgLtv: 'متوسط القيمة',
    seg_revShare: 'حصة الإيرادات',
    seg_createCampaign: 'تصدير الشريحة',
    seg_createCampaignAll: 'تصدير جميع العملاء',
    seg_exportAll: 'تصدير الكل',
    seg_noData: 'لا توجد بيانات RFM بعد. ارفع ملف CSV يحتوي على معرف العميل وتاريخ الطلب والمبلغ الإجمالي.',
    seg_clearFilter: 'إزالة الفلتر',
    seg_customers: 'عميل',
    seg_dataPoints: 'عميلًا في البيانات',
    seg_inSegment: 'في الفئة',
    seg_familyChampion: 'الأبطال',
    seg_familyLoyal: 'الموالون',
    seg_familyNew: 'جدد / واعدون',
    seg_familyRisk: 'في خطر',
    seg_campaignHint: 'تصدير {n} عميلًا في فئة "{seg}" كقائمة CSV.',
    seg_dragHint: 'اسحب للتحريك، انقر للتصفية',
    seg_resetPositions: 'إعادة المواضع',
    ...
    onb_sourceCurrencyLabel: 'عملة ملف CSV',
    onb_sourceCurrencyHint: 'ما هي عملة المبالغ في ملفك؟ نستخدمها لتحويل القيم إلى عملة العرض المفضلة لديك.',
    onb_sourceCurrencyAuto: 'اكتشاف تلقائي من الملف',
    ...
    settings_themeHint: 'بدّل بين الوضع الفاتح والداكن',
    settings_languageLabel: 'اللغة',
    settings_languageHint: 'اختر لغة العرض المفضلة',
    settings_signOut: 'تسجيل الخروج',
    settings_company: 'الشركة',
    settings_companyDesc: 'خصّص طريقة ظهور علامتك التجارية في InsightX',
    settings_companyName: 'اسم الشركة',
    settings_companyNamePlaceholder: 'اسم شركتك',
    settings_manageAccountPrefs: 'إدارة تفضيلات حسابك',
    settings_preferences: 'التفضيلات',
    settings_currency: 'العملة',
    settings_currencyHint: 'تُستخدم لتنسيق الإيرادات في لوحات التحكم',
    settings_noLogo: 'لم يتم رفع شعار بعد',
    settings_uploadLogo: 'رفع الشعار',
    settings_changeLogo: 'تغيير الشعار',
    settings_logoMustBeImage: 'يجب أن يكون الشعار ملف صورة (PNG، JPG، SVG).',
    settings_logoTooLarge: 'حجم ملف الشعار كبير جداً.',
    settings_save: 'حفظ التغييرات',
    settings_saving: 'جاري الحفظ…',
    settings_saved: 'تم الحفظ',
    settings_accountActions: 'إجراءات الحساب',
  },
} as const;
