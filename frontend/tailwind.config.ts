  ...
  theme: {
    extend: {
      colors: {
        ...
        primary: {
          DEFAULT: "#137fec",
          hover:   "#2563eb",   // enables bg-primary-hover / hover:bg-primary-hover in 13 files
          50: "#eff6ff",
          100: "#dbeafe",
          200: "#bfdbfe",
          300: "#93c5fd",
      ...
      animation: {
        ...
        // Marching-ants on dashed SVG paths — used by the forecasting chart so
        // the forecast line visually "flows forward" rather than sitting flat,
        // helping the eye distinguish projection from recorded history.
        "dash-flow":    "dash 1.4s linear infinite",
        // Floating bubbles for the segmentation page. Three variants with
        // slightly different periods so a cluster of bubbles drifts
        // asynchronously instead of marching in lockstep (looks alive).
        "float-slow":   "float 8s ease-in-out infinite",
        "float-medium": "float 6s ease-in-out infinite",
        "float-fast":   "float 5s ease-in-out infinite",
        // Dashed connection lines between bubbles "flow" along their path so
        // the segments visually feel networked rather than static.
        "line-flow":    "flow 20s linear infinite",
      },
      keyframes: {
        ...
        flow: {
          "0%":   { strokeDashoffset: "20", opacity: "0.3" },
          "50%":  { opacity: "0.8" },
