...
| **Data Layer** | PostgreSQL (DO Managed) | Single relational store for all data; MongoDB removed 2026-05-14 |
...
## Notes
- **Database**: PostgreSQL (DO Managed) is the single source of truth. MongoDB was removed in favour of a Postgres-only stack.
