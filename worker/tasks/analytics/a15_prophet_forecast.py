...
def run(df: pd.DataFrame) -> dict[str, Any]:
    ...
    return {
        "summary": {
            ...
            "total_revenue_30d_forecast": horizon_totals.get(30, 0.0),
            "total_revenue_60d_forecast": horizon_totals.get(60, 0.0),
            "total_revenue_90d_forecast": horizon_totals.get(90, 0.0),
            "total_revenue_180d_forecast": horizon_totals.get(180, 0.0),
